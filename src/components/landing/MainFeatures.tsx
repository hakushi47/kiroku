  ...
  const features = [
    {
      ...
      title: "カウンセリングシート管理",
      description: "お客様のご要望を効率的に記録・管理できます",
    ...
    },
    {
      ...
      title: "QRコード生成機能",
      description: "簡単にQRコードを作成し、お客様に共有できます",
    ...
    },
    {
      ...
      title: "顧客情報管理",
      description: "お客様の情報を安全に管理し、サービス向上に活用",
      bgColor: "bg-primary-dark"
    },
    {
      icon: (
      ...
      title: "性の知識ノート",
      description: "専門知識を記録し、サービス向上に活用",
      bgColor: "bg-accent-400"
    },
    {
      icon: (
      ...
      title: "レスポンス分析",
      description: "お客様の回答を分析し、サービス改善に活用",
      bgColor: "bg-primary-dark"
    },
    {
      icon: (
      ...
      title: "モバイル対応",
      description: "スマートフォンやタブレットでいつでもどこでも利用可能",
      bgColor: "bg-accent-400"
    }
  ];
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-12">
          ...
          <p className="text-lg text-primary-dark max-w-3xl mx-auto">
            お客様との関係を深め、より良いサービスを提供するために必要な機能を全て搭載
          </p>
        </div>
